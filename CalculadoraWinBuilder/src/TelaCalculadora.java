...
public class TelaCalculadora {
	...
	private void initialize() {
		...
		frame.getContentPane().setBackground(new Color(214, 202, 221));
		frame.setBounds(100, 100, 366, 555);
		...
		btnAC.setBackground(new Color(0, 0, 0));
		...
		btnOps.setBackground(new Color(255, 255, 255));
		...
		btnP.setBackground(new Color(255, 255, 255));
